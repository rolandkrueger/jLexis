...
public class EditFileAction extends JLexisAbstractAction
{
  private static final long serialVersionUID = 1908884041976894290L;

  public EditFileAction ()
  {
    super (I18NResources.getString (I18NResourceKeys.EDIT_FILE_KEY),
           JLexisResourceManager.getInstance ().getIcon (ResourcesEnums.EDIT_FILE_ICON));
//  TODO I18N
    putValue (Action.SHORT_DESCRIPTION, "Vokabeln eintragen.");
  }
