...
import info.rolandkrueger.jlexis.data.vocable.verification.VocableVerificationData.UnmodifiableVocableVerificationData;
...
public final class UnmodifiableVocable extends Vocable
{
  ...
  private final class UnmodifiableUserInput implements UserInputInterface
  {
    ...
    {
      return new UnmodifiableVocableVerificationData (mData.getQuizVerificationData ());
    }
