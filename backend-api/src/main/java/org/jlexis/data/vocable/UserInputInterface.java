...
public interface UserInputInterface {
     ...
     * identified by an identifier which will be used as the key into the {@link java.util.Map} data structure
     ...
     * @throws IllegalStateException if an identifier is used that hasn't been registered with this
