...
public final class EmptyTerm extends AbstractTerm {

    private static UnmodifiableTerm instance = new UnmodifiableTerm(new EmptyTerm());

    public static AbstractTerm instance() {
        return instance;
    }

    private EmptyTerm() {
        setUserEnteredString("");
    }
